...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure
{
    internal sealed class CompiledPageActionDescriptorFactory
    {
        ...
        public CompiledPageActionDescriptor CreateCompiledDescriptor(PageActionDescriptor actionDescriptor, CompiledViewDescriptor viewDescriptor)
        {
            ...
            var compiledDescriptor = CompiledPageActionDescriptorBuilder.Build(context.PageApplicationModel, _globalFilters);
            actionDescriptor.CompiledPageDescriptor = compiledDescriptor;
