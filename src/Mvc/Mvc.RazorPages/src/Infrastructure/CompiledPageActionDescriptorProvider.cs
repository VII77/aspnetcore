...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure
{
    ...
    /// </summary>
    internal class CompiledPageActionDescriptorProvider : IActionDescriptorProvider
    {
        ...
        public void OnProvidersExecuting(ActionDescriptorProviderContext context)
        {
            ...
            foreach (var viewDescriptor in feature.ViewDescriptors)
            {
                ...
                lookup.TryAdd(viewDescriptor.RelativePath, viewDescriptor);
            }
            ...
            foreach (var item in newContext.Results)
            {
                ...
                var compiledPageActionDescriptor = _compiledPageActionDescriptorFactory.CreateCompiledDescriptor(pageActionDescriptor, compiledViewDescriptor);
