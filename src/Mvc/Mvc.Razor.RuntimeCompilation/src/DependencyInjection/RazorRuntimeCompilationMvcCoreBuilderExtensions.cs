    ...
    public static class RazorRuntimeCompilationMvcCoreBuilderExtensions
    {
        ...
        internal static void AddServices(IServiceCollection services)
        {
            ...
            var actionDescriptorProvider = services.FirstOrDefault(f =>
                ...
                f.ImplementationType?.Assembly == typeof(PageActionDescriptorProvider).Assembly &&
                f.ImplementationType.FullName == "Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure.CompiledPageActionDescriptorProvider");
